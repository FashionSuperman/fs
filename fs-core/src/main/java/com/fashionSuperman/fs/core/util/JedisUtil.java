...
/**
 * 使用该类需要在spring中配置{@link JedisPool}连接池
 * 对redis的操作封装成了6个内部类 {@link Keys Strings Lists Sets Hash SortSet}
 * 分别对应redis的key操作以及五种数据类型的操作,直接通过属性直接获取相应的类型进行操作
 * 
 * 也可以使用spring-data-redis来代替该类的功能
 * 
 * @description 
 * @author FashionSuperman
 * @date 2017年2月23日 下午3:40:53
 * @version 1.0
 */
@Service
